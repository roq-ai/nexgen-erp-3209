...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`nexgen erp`}</title>

        <meta
          name="description"
          content="Welcome to Nexgen ERP - Your complete solution for electrical goods purchase and inventory, facilitating efficient generation of purchase orders and insightful reports."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1562184230-4e1fc4341254?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlbGVjdHJpY2FsJTIwZ29vZHN8ZW58MHx8fHwxNjk1NzIyMjk1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@room?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`ROOM`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Nexgen ERP - Your complete solution for electrical goods purchase and inventory, facilitating efficient generation of purchase orders and insightful reports.`}
            </Text>
            <Box
